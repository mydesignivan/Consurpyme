        ...
        <div class="proyecto span-19 push-1">
            <form action="" name="form1" method="post" enctype="multipart/form-data">
                <div class="span-10 space-bottom">
                    <span>T&iacute;tulo</span><input class="float-right input1 border" type="text" name="txtTitle" value="<?=getval($data, "title");?>" />
                </div>
                ...
                <div class="span-11 clear space-bottom2">
                    <span>Im&aacute;gen 1</span><input type="file" class="float-right input1 border" name="uploadFile[]" />
                </div>
                <div class="span-7 clear space-bottom">
                ...
                <input type="hidden" name="proyect_id" value="<?=getval($data, "gallery_id");?>" />
            </form>
        </div>
    </div>
